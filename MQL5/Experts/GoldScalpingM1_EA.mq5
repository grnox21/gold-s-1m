...
input int    InpTrailingStepPoints = 10;         // Minimum improvement, points, required before the trailing SL is moved again
...
double OnTester()
{
   ...
   double dd     = TesterStatistics(STAT_BALANCE_DD_MAXIMUM_PERCENT);
   if(dd <= 0.0)
      return profit;
   return profit / dd;
}
